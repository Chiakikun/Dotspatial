...
<qgis minScale="1e+08" styleCategories="AllStyleCategories" maxScale="0" version="3.16.13-Hannover" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" opacity="1" alphaBand="-1" nodataColor="" classificationMin="0" classificationMax="149" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader minimumValue="0" labelPrecision="4" classificationMode="1" colorRampType="INTERPOLATED" clip="0" maximumValue="149">
          ...
          <item alpha="255" label="0.0000" value="0" color="#76b6ee"/>
          <item alpha="255" label="74.5000" value="74.5" color="#f7f7f7"/>
          <item alpha="255" label="149.0000" value="149" color="#ca0020"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
